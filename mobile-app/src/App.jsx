...
function App() {
  ...
  function concluirImportacaoBanco() {
    limparSessao();
    toast.info("Banco importado. Entre novamente para carregar os dados restaurados.");
  ...
  useEffect(() => {
    ...
    CapacitorApp.addListener("backButton", () => {
      ...
      if (telaConfiguracoes || telaAdminUsuarios || telaAtual !== "inicio") {
        voltarParaInicio();
        return;
      }
